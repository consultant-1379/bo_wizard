...
<!--When checked change the attribute to checked="yes".-->
			...
			<front><?Pub Dtl?>
				<title-page>
					<copyright>
						...
						<p> &#169; Ericsson LMI <xsl:value-of select="document/tp_description/@modyear" />. All rights reserved. No part of this document may be reproduced in any form without the written permission of the copyright owner.</p>
					</copyright>
					<disclaimer>
					...
					<trademark-list>
						...
						<tm-item>
							<trademark></trademark>
							<owner>All trademarks mentioned herein are the property of their respective owners. These are shown in the document Trademark Information.</owner>
						</tm-item>
					</trademark-list>
				</title-page>
			</front>
			...
			<body><?Pub Dtl?>
				<chl1>
					...
					<p>Technology Package: <xsl:value-of select="document/tp_description/@ericssonVersion" /></p>
					<p><xsl:value-of select="document/tp_description/@version" /></p>
					<p><xsl:value-of select="document/tp_description/@releases" /></p>
					<p><xsl:value-of select="document/tp_description/@Product" /></p>
				...
				<chl1><?Pub Caret?>
					...
					<p>This section describes relations between measurement objects and topology objects. 
It defines which topology is used with each measurement.</p>
					
					<xsl:for-each select="document/tp_object_hierarchy/class">
						<xsl:if test="object = true()">
							<table>
								<caption><xsl:value-of select="@link" /></caption>
								<tgroup cols="1">								
									<tbody>
										<xsl:if test="object = true()">
											<row>
				...
				<chl1>
					...
					<p>This section describes the objects in the universe.</p>
					<table>
				...
				<chl1>
					...
					<p>This section describes the conditions in the universe.</p>
					<table>
				...
				<reference>
					<reference-list>
						<rf-subsection></rf-subsection>
							<rf-item>
								<rf-title>Operations Support System (OSS) Glossary, 0033-AOM 901 017/2</rf-title>
							</rf-item>
					</reference-list>
				</reference>
			</back>
