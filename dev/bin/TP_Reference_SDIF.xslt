...
<xsl:output version="1.0" encoding="UTF-8" indent="no" omit-xml-declaration="no" media-type="text/sdif" />
<xsl:template match="/">
...
<doc-info></doc-info>
<doc-id>
<doc-no type="registration">1/1550/<xsl:value-of select="document/tp_description/@product" /></doc-no><language code="en"/>
...
<xsl:if test="object = true()">
	<p><emph><xsl:value-of select="@link" /></emph></p>
	<table>
	<tgroup cols="1">
	<tbody>
	<xsl:if test="object = true()">
		<row><entry valign="top"><tp><xsl:value-of select="@name" /></tp></entry></row>
	</xsl:if>
	...
	<xsl:for-each select="./class">
		<xsl:if test="@link != ../@link">
			<row><entry valign="top"><tp><emph><xsl:value-of select="@link" /></emph></tp></entry></row>
		</xsl:if>
		<xsl:if test="object = true()">
			<row><entry valign="top"><tp><xsl:value-of select="../@name" /> / <xsl:value-of select="@name" /></tp></entry></row>
		</xsl:if>
		<xsl:for-each select="./object">
			<row><entry valign="top"><tp>- <xsl:value-of select="@name" /></tp></entry></row>
		</xsl:for-each>
		...
		<xsl:for-each select="./class">
			...
			<xsl:if test="object = true()">
				<row><entry valign="top"><tp><xsl:value-of select="../../@name" /> / <xsl:value-of select="../@name" /> / <xsl:value-of select="@name" /></tp></entry></row>
			</xsl:if>
			<xsl:for-each select="./object">
				<row><entry valign="top"><tp>- <xsl:value-of select="@name" /></tp></entry></row>
			</xsl:for-each>
			...
			<xsl:for-each select="./class">
				...
				<xsl:if test="object = true()">
					<row><entry valign="top"><tp><xsl:value-of select="../../../@name" /> / <xsl:value-of select="../../@name" /> / <xsl:value-of select="../@name" /> / <xsl:value-of select="@name" /></tp></entry></row>
				</xsl:if>
				<xsl:for-each select="./object">
					<row><entry valign="top"><tp>- <xsl:value-of select="@name" /></tp></entry></row>
				</xsl:for-each>
...
<xsl:if test="object = true()">
<row>
<entry valign="top"><tp><emph><xsl:value-of select="@name" /></emph></tp></entry>
<entry valign="top"><tp><xsl:value-of select="@description" /></tp></entry>
<entry valign="top"><tp><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></tp></entry>
</row>
</xsl:if>

<xsl:for-each select="./object">
<row>
<entry valign="top"><tp><xsl:value-of select="@name" /></tp></entry>
<entry valign="top"><tp>
...
<xsl:if test="object = true()">
<row>
<entry valign="top"><tp><emph><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></emph></tp></entry>
<entry valign="top"><tp><emph><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></emph></tp></entry>
<entry valign="top"><tp><emph><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></emph></tp></entry>
</row>
<row>
<entry valign="top"><tp><emph><xsl:value-of select="../@name" /> / <xsl:value-of select="@name" /></emph></tp></entry>
</row>
</xsl:if>
<xsl:for-each select="./object">
<row>
...
<row>
<entry valign="top"><tp><emph><xsl:value-of select="../../@name" /> / <xsl:value-of select="../@name" /> / <xsl:value-of select="@name" /></emph></tp></entry>
</row>
</xsl:if>
<xsl:for-each select="./object">
<row>
...
<row>
<entry valign="top"><tp><emph><xsl:value-of select="../../../@name" /> / <xsl:value-of select="../../@name" /> / <xsl:value-of select="../@name" /> / <xsl:value-of select="@name" /></emph></tp></entry>
</row>
</xsl:if>
<xsl:for-each select="./object">
<row>
